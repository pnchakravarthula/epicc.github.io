...
test('dx_raf: input: "E119", 65, "v24","CNA","F",True,True,True,900 output: "0.106"', () => {
    expect(dx_raf("E119",65, "v24","CNA","F","True","True","True",900)).toBe('0.106');
});

//dx_raf Fail Test Cases
test('dx_raf: input: "E1111",40, "v22","CFA","F","True","True","True",900 output: "0.307"', () => {
    expect(dx_raf("E1111",40, "v22","CFA","F","True","True","True",900)).not.toBe('0.307');
});
...
test('dx_gap_raf: input: "T8602","C770","v23","CFA" output: "-0.855"', () => {
    expect(dx_gap_raf("T8602","C770","v23","CFA")).not.toBe('-0.855');
});
...
test('Test for CC_INFO (CASE 1)', () => {
    expect(cc_info("HCC85", "v23", "CFA")).toBe("desc: Congestive Heart Failure; children: ; parents: ; RAF: 0.3550");
});

test('Test for CC_INFO (CASE 2)', () => {
    expect(cc_info("HCC10", "v22", "CPD")).toBe("desc: Lymphoma and Other Cancers; children: HCC11,HCC12; parents: HCC8,HCC9; RAF: 0.5770");
});
...
test('Test for CC_GAP (CASE 1) ', () => {
    expect(cc_gaps("HCC19,HCC85","HCC17,HCC18,HCC55","v22")).toBe("HCC85,HCC85_gDiabetesMellit");
});
...
test('Test for CC_GAP (CASE 3) ', () => {
    expect(cc_gaps("HCC18,HCC19","HCC85,HCC55")).not.toBe("HCC18");
});
